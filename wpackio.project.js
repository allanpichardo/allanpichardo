...
module.exports = {
	// Project Identity
	appName: 'allanpichardo', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'allanpichardo', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	...
	watch: './template-parts|inc|includes/**/*.php',
